...
(function (Caml) {
    ...
    })(ViewScope = Caml.ViewScope || (Caml.ViewScope = {}));
    ...
    })(DateRangesOverlapType = Caml.DateRangesOverlapType || (Caml.DateRangesOverlapType = {}));
    var StringBuilder = /** @class */ (function () {
        function StringBuilder(initialText) {
            var _this = this;
            this.append = function (text) {
                _this._parts[_this._parts.length] = text;
            };
            this.appendLine = function (text) {
                _this._parts[_this._parts.length] =
            ...
            this.isEmpty = function () {
                if (_this._parts.length === 0)
                    return true;
                return _this.toString() === '';
            };
            this.toString = function (separator) {
                separator = separator || '';
                var parts = _this._parts;
                if (_this._len !== parts.length) {
                    _this._value = {};
                    _this._len = parts.length;
                }
                var val = _this._value;
                if (typeof (val[separator]) === 'undefined') {
                    ...
                    val[separator] = _this._parts.join(separator);
                }
    ...
    Caml.StringBuilder = StringBuilder;
    var SPScriptUtility = /** @class */ (function () {
        function SPScriptUtility(stringBuilder) {
            var _this = this;
            this.$f_0 = null;
            this.$1_0 = null;
            this.$11_0 = null;
            this.$V_0 = false;
            this.$k_0 = false;
            this.isNullOrEmptyString = function (str) {
                var strNull = null;
            ...
            this.writeStartElement = function (tagName) {
                _this.$1R_0();
                _this.$1A_0();
                _this.$f_0.push(tagName);
                _this.$11_0 = tagName;
                _this.$1_0.append('<');
                _this.$1_0.append(tagName);
                _this.$V_0 = false;
                _this.$k_0 = false;
            };
            this.writeElementString = function (tagName, value) {
                _this.$1R_0();
                _this.$1A_0();
                _this.writeStartElement(tagName);
                _this.writeString(value);
                _this.writeEndElement();
            };
            this.writeEndElement = function () {
                _this.$1R_0();
                if (_this.isNullOrEmptyString(_this.$11_0)) {
                ...
                if (!_this.$V_0) {
                    ...
                    _this.$1_0.append('</');
                    _this.$1_0.append(_this.$11_0);
                    _this.$1_0.append('>');
                }
                _this.$f_0.pop();
                if (_this.$f_0.length > 0) {
                    _this.$11_0 = _this.$f_0[_this.$f_0.length - 1];
                }
                else {
                    _this.$11_0 = null;
                }
            ...
            this.writeAttributeString = function (localName, value) {
                if (_this.$V_0) {
                    throw "Invalid operation";
                }
                _this.$1_0.append(' ');
                _this.$1_0.append(localName);
                _this.$1_0.append('=\"');
                _this.$1T_0(value, true);
                _this.$1_0.append('\"');
            };
            this.writeStartAttribute = function (localName) {
                if (!_this.$V_0) {
                    throw "Invalid operation";
                }
                _this.$k_0 = true;
            ...
            this.writeString = function (value) {
                if (_this.$k_0) {
                    _this.$1T_0(value, true);
                    _this.$1_0.append(value);
                }
                else {
                    _this.$1A_0();
                    _this.$1T_0(value, false);
                }
            };
            this.writeRaw = function (xml) {
                _this.$1R_0();
                _this.$1A_0();
                _this.$1_0.append(xml);
            };
            this.$1R_0 = function () {
                if (_this.$k_0) {
                    throw "Invalid operation";
            ...
            this.$1T_0 = function ($p0, $p1) {
                if (_this.isNullOrEmptyString($p0)) {
                    return;
                }
                for (var $v_0 = 0; $v_0 < $p0.length; $v_0++) {
                    ...
                    switch ($v_1) {
                        ...
                        case 13:
                            ...
                            break;
                        default:
                            _this.$1_0.append(($p0.charAt($v_0)).toString());
                            break;
                    }
                }
            };
            this.close = function () { return undefined; };
            this.$f_0 = [];
            this.$1_0 = stringBuilder;
            this.$V_0 = true;
        }
        SPScriptUtility.create = function (sb) {
            return new SPScriptUtility(sb);
        };
        return SPScriptUtility;
    }());
    Caml.SPScriptUtility = SPScriptUtility;
    var Builder = /** @class */ (function () {
        function Builder() {
            this.LOG_SOURCE = "camljs-Builder";
            this.tree = new Array();
            this.unclosedTags = 0;
        }
        Builder.prototype.SetAttributeToLastElement = function (tagName, attributeName, attributeValue) {
            ...
            Logger.write("CamlJs ERROR: can't find element '" + tagName + "' in the tree while setting attribute " + attributeName + " to '" + attributeValue + "'!\" - " + this.LOG_SOURCE + " (SetAttributeToLastElement)", 3 /* Error */);
        };
        ...
        Builder.prototype.WriteFieldRef = function (fieldInternalName, options) {
            ...
            if (options)
                for (var _i = 0, _a = Object.getOwnPropertyNames(options) || []; _i < _a.length; _i++) {
                    var name_1 = _a[_i];
                    fieldRef[name_1] = options[name_1];
                }
        ...
        Builder.prototype.Finalize = function () {
            ...
            var writer = SPScriptUtility.create(sb);
            for (var i = 0; i < this.tree.length; i++) {
                if (this.tree[i].Element == "FieldRef") {
                    ...
                    for (var _i = 0, _a = this.tree[i]; _i < _a.length; _i++) {
                        var attr = _a[_i];
        ...
        JoinsManager.prototype.Finalize = function () {
            if (this.joins.length > 0) {
                ...
                for (var j = 0; j < this.projectedFields.length; j++) {
                    var projField = this.projectedFields[j];
    ...
    var RawQueryInternal = /** @class */ (function () {
        function RawQueryInternal(xml) {
            this.LOG_SOURCE = "camljs-RawQueryInternal";
            this.xml = xml;
        }
        ...
        RawQueryInternal.prototype.modifyWhere = function (modifyType) {
            ...
            if (whereBuilder == null)
                Logger.write("CamlJs error: cannot find Query tag in provided XML - " + this.LOG_SOURCE + " (modifyWhere)", 3 /* Error */);
            ...
            switch (modifyType) {
                ...
                case ModifyType.AppendOr:
                    ...
                    return new FieldExpression(builder);
                default:
                    Logger.write("CamlJs error: unknown ModifyType " + modifyType + " - " + this.LOG_SOURCE + " (modifyWhere)", 3 /* Error */);
                    return null;
            }
        };
        ...
        RawQueryInternal.prototype.parseRecursive = function (builder, node, modifyType) {
            ...
            for (var j = 0, clen = node.childNodes.length; j < clen; j++) {
                if (node.nodeName == "Query" && node.childNodes[j].nodeName == "Where") {
                    ...
                    var whereNode = node.childNodes[j];
                ...
                var result = this.parseRecursive(builder, node.childNodes[j], modifyType);
                if (found == null)
                    found = result;
            }
            if (!found) {
    ...
    var ViewInternal = /** @class */ (function () {
        function ViewInternal() {
            this.LOG_SOURCE = "camljs-ViewInternal";
        ...
        ViewInternal.prototype.Scope = function (scope) {
            switch (scope) {
                ...
                case ViewScope.RecursiveAll:
                    ...
                    break;
                default:
                    Logger.write("Incorrect view scope! Please use values from CamlBuilder.ViewScope enumeration. - " + this.LOG_SOURCE + " (Scope)", 3 /* Error */);
                    break;
            }
            return this;
        };
