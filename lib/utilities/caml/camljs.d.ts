export declare namespace Caml {
    ...
    class StringBuilder {
        ...
        private _value;
        private _len;
        constructor(initialText: any);
        append: (text: any) => void;
        appendLine: (text: any) => void;
        clear: () => void;
        isEmpty: () => boolean;
        toString: (separator?: string) => any;
    }
    class SPScriptUtility {
        private $f_0;
        private $1_0;
        private $11_0;
        private $V_0;
        ...
        isNullOrEmptyString: (str: any) => boolean;
        static create: (sb: StringBuilder) => SPScriptUtility;
        writeStartElement: (tagName: any) => void;
        writeElementString: (tagName: any, value: any) => void;
        writeEndElement: () => void;
        $1A_0: () => void;
        writeAttributeString: (localName: any, value: any) => void;
        writeStartAttribute: (localName: any) => void;
        writeEndAttribute: () => void;
        writeString: (value: any) => void;
        writeRaw: (xml: any) => void;
        $1R_0: () => void;
        $1T_0: ($p0: any, $p1: any) => void;
        close: () => any;
    }
    class CamlValues {
...
export declare class CamlBuilder {
    constructor();
    /** Generate CAML Query, starting from <Where> tag */
    Where(): Caml.IFieldExpression;
    ...
    View(viewFields?: string[]): Caml.IView;
    /** Generate <ViewFields> tag for SPServices */
    ViewFields(viewFields: string[]): Caml.IFinalizableToString;
    /** Use for:
        1. SPServices CAMLQuery attribute
        2. Creating partial expressions
        3. In conjunction with Any & All clauses
         */
    static Expression(): Caml.IFieldExpression;
    static FromXml(xml: string): Caml.IRawQuery;
}
//# sourceMappingURL=camljs.d.ts.map